...
ax.plot(position[:,0], position[:,1], position[:,2], label='real trajectory')
ax.plot(position1[:,0], position1[:,1], position1[:,2], label='integral trajectory without noise')
ax.plot(position2[:,0], position2[:,1], position2[:,2], label='integral trajectory with noise')
